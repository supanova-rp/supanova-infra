  ...
  policy = jsonencode({
    ...
    Statement = [
      ...
      },
      {
        ...
        Resource = [
          "arn:aws:iam::*:user/supanova-maintenance-prod",
          "arn:aws:iam::*:user/supanova-server-prod"
        ]
      },
      {
        ...
        Resource = [
          "arn:aws:iam::*:policy/supanova_maintenance_prod_policy",
          "arn:aws:iam::*:policy/supanova_server_prod_policy"
        ]
      },
      {
